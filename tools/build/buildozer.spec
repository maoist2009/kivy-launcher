...
source.include_exts = py,png,jpg,kv,atlas,json,ttf,svg,txt
...
requirements = python3,kivy,android,ahocorasick-python,requests,dnspython,pyjnius,https://github.com/kvdroid/Kvdroid/archive/refs/heads/master.zip
